...
- [[../../大厂技术文章-DailyTech/文章/得物活动Agent-从表单到LangGraph的社区活动搭建实践|得物社区活动搭建 AI 实践]] — Interrupt/Resume、Human-in-the-loop、Checkpointer 持久化的国内落地案例
- [[../../大厂技术文章-DailyTech/文章/业务需求专家Agent-端到端搭建指南|端到端业务需求专家 Agent]] — 四层架构、纵向闭环

### 架构与 Agent 基础

- [[LLM大模型学习|LLM 大模型学习]]
- [[深入理解OpenClaw技术架构与实现原理（上）|OpenClaw 技术架构]]
