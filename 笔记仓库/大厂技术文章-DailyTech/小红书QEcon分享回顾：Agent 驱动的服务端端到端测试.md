...
# 小红书 QEcon 分享回顾：Agent 驱动的服务端端到端测试
...
![图1](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_01.jpg>)

![图2](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_02.jpg>)

**1.1 一个被忽视的信号：测试金字塔正在变成"橄榄型"**

近年来，自动化测试的分层模型出现了一个明显演变——从经典的金字塔型逐渐变为橄榄型：底部单元测试收窄，中部的集成测试与端到端测试不断膨胀。

![图3](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_03.png>)
...
![图4](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_04.png>)
...
![图5](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_05.png>)

![图6](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_06.jpg>)
...
![图7](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_07.png>)

**2.1 整体架构：一个大脑，四个工具**

![图8](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_08.png>)
...
![图9](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_09.jpg>)
...
![图10](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_10.png>)
...
![图11](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_11.png>)

![图12](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_12.png>)
...
![图13](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_13.png>)
...
![图14](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_14.png>)
...
![图15](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_15.png>)
...
![图16](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_16.png>)

![图17](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_17.png>)
...
![图18](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_18.png>)

2. 造数计划生成

![图19](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_19.png>)

3. 执行造数

![图20](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_20.png>)

4. 造数结果

![图21](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_21.png>)
...
![图22](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_22.png>)

![图23](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_23.png>)

2. 生成计划

![图24](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_24.png>)

3. 脚本召回：匹配脚本直接执行；相似脚本，参考编写

![图25](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_25.png>)

![图26](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_26.png>)

4. 测试完成，结果汇总

![图27](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_27.png>)

![图28](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_28.jpg>)
...
![图29](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_29.jpg>)
...
![图30](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_30.png>)
...
![图31](<assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/img_31.png>)

> **图片说明**: 原文 31 张配图位于 assets/小红书QEcon分享回顾：Agent 驱动的服务端端到端测试/，微信 CDN 原链可能过期。
...
**《[[大厂技术文章-DailyTech/用 LLM Agent 重构告警排查流程｜得物技术|告警排查Agent]]》**：得物用 ReAct + 动态策略组装做运维排查；小红书同样采用 ReAct 微观执行，但场景换成跨域 E2E 测试，且强调 Plan-and-Execute 宏观规划与逆向依赖推导。

**《[[大厂技术文章-DailyTech/verify-data一个端到端的数据验数Agent Skill|数据验数Agent]]》**：verify-data 聚焦 SQL 验数红线；本文数据构造场景与之同属「测试数据/结果自动化」赛道，但本文覆盖更长的跨域业务链路而非单表验数。

**《[[大厂技术文章-DailyTech/如何搭建一个端到端业务需求专家 Agent|业务需求专家Agent]]》**：该文四层架构强调纵向闭环；本文「测试分析 → 执行 → 知识管理」三角 Agent 愿景是同一「端到端 Agent 化」思路在质效领域的延伸。

**《[[大厂技术文章-DailyTech/AI Agent系列｜深入解析Function Calling、MCP和Skills的本质差异与最佳实践|MCP与Skills差异]]》**：该文辨析 MCP 封装边界；本文明确**拒绝**「接口封装为 MCP 再编排」的主流路径，认为多一层封装即多一层腐化，应让 Agent 直接 exec-skill 调业务接口。

**《[[大厂技术文章-DailyTech/AI 不缺智商缺纪律：我的 Harness 工程化实践|Harness实践]]》**：小红书 AI Coding 团队明确将「AI Coding harness」列为核心方向；本文 script-mgr 飞轮、能力预检、Debug-first 均是 Harness 纪律在测试域的具体化。
