...
**《[[技术文章-DailyTech/当 Agent 替你值班：基于 Devix 构建 7x24 自动化运维 Harness Engineering|Agent运维Harness]]》**：两篇文章都涉及"Agent 在场"的概念——运维 Agent 需要 7x24 不间断监控告警，JoyAI-VL 需要持续观察视频流。核心范式相似：持续监控 → 自主判断 → 分级响应/委派。
