---
title: ExecuteHMEFlowTask 调用链分析
tags: [日结, EOD, Quartz, Activiti, 定时任务, Redis, 工作流]
module: bcadmin-system/src/main/java/com/resrun/modules/quartz/task
date: 2026-06-01
type: code-analysis
related: [EOD日结流程, 交易时段CurvedateSession]
---
